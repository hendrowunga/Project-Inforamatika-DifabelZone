            ...
            <div class="col-md-12 col-sm-12">
                ...
                <div class="row mt-4">
                    ...
                    <div class="col-md-6 col-sm-12 text-right">
                        <div class="dropdown">
                            <a class="btn btn-primary" href="{{ route('admin.manage-products.product_create') }}"
                                role="button">
                                New Product
                            </a>
                        </div>
                                        ...
                                        @forelse ($products as $index => $product)
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <span
                                                        class="badge {{ $product->is_featured ? 'badge-success' : 'badge-danger' }}">
                                                        <i
                                                            class="bi {{ $product->is_featured ? 'bi-check-circle' : 'bi-x-circle' }}"></i>
                                                    </span>
                                                </td>
                                                <td class="text-center">
                                                    <span
                                                        class="badge {{ $product->on_sale ? 'badge-success' : 'badge-danger' }}">
                                                        <i
                                                            class="bi {{ $product->on_sale ? 'bi-check-circle' : 'bi-x-circle' }}"></i>
                                                    </span>
                                                </td>
                                                <td class="text-center">
                                                    <span
                                                        class="badge {{ $product->in_stock ? 'badge-success' : 'badge-danger' }}">
                                                        <i
                                                            class="bi {{ $product->in_stock ? 'bi-check-circle' : 'bi-x-circle' }}"></i>
                                                    </span>
                                                </td>
                                                <td class="text-center">
                                                    <span
                                                        ...
                                                        <i
                                                            class="bi {{ $product->is_active ? 'bi-check-circle' : 'bi-x-circle' }}"></i>
                                                    </span>
                                                </td>
                                                <td class="text-center">
                                                    <div class="dropdown">
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="deleteModalLabel">Delete Product
                                                            </h5>
